...
compressive modes.
Note that $b\sim0.4$ is obtained if a natural mixture (a 2:1 mixture) of
solenoidal and compressive modes is injected by the turbulent driver, i.e., a
forcing ratio $F_{comp}/F_{sol} = 1/2$. Thus, $b>0.4$ implies an enhanced
...
We examine the line of sight towards G43.17+0.01, also known as W49A.  In a 
...
by a factor of 9 so the smaller lines can be seen.  \todo{CUT for letter-form}
}{fig:w49fullspec}{1}
...
region because of the higher signal-to-noise at that location.  \todo{The detected
