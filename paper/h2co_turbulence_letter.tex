...
\FigureTwo{figures/lognormalsmooth_density_ratio_massweight_withhopkins_logopr0.0_abund-9_withG43.png}
          {figures/lognormalsmooth_density_ratio_massweight_withhopkins_logopr0.0_abund-8.25_withG43.png}
{The predicted \formaldehyde \oneone/\twotwo ratio as a function of volume-weighted mean
density for a fixed abundance relative to \hh $X(\ortho) = 10^{-9}$ (left) and $X(\ortho)=10^{-8.25}$ (right) with \hh
