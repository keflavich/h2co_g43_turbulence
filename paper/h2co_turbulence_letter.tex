...
ratio $\tau_{\oneone}/\tau_{\twotwo} = 6.99^{+0.72}_{-0.56} $.  Assuming a
lognormal distribution for the density, and using only the $\tau$ measurements
as a constraint, we derive the value for $\sigma_s$ in Table
\ref{tab:datafits}.
